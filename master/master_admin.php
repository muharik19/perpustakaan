...
<head>
  ...
  <link rel="shortcut icon" href="images/unpam.jpg">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="#">Perpustakaan UNPAM</a>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Perpustakaan UNPAM</li>
      </ol>
      <div class="row">
        <div class="col-12">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © AL Technology 2017</small>
        </div>
      </div>
    </footer>
